...
namespace AddList
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            string exe1 = @"Auto7z_GUI.exe";
            exe1Path = Path.Combine(workPath, exe1);

            string exe2 = @"Auto7z_RAR_GUI.exe";
            exe2Path = Path.Combine(workPath, exe2);
            ...
            if (File.Exists(exe1Path))
            {
                ...
                try
                {
                    bool auto7zForFile = AddContextMenuItem(@"Software\Classes\*\shell\auto7z", filePath);
                    bool auto7zForFolder = AddContextMenuItem(@"Software\Classes\Directory\shell\auto7z", filePath);
